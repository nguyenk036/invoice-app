  ...
  public: {
    Tables: {
      ...
      clients: {
        ...
        Update: Partial<Omit<Client, "id" | "profile_id" | "created_at" | "updated_at">>;
      };
      pricing_presets: {
        Row:    PricingPreset;
        Insert: Omit<PricingPreset, "id" | "created_at">;
        Update: Partial<Omit<PricingPreset, "id" | "profile_id" | "created_at">>;
      };
      quotes: {
        Row:    Quote;
        Insert: Omit<Quote, "id" | "created_at" | "updated_at">;
        Update: Partial<Omit<Quote, "id" | "profile_id" | "created_at" | "updated_at">>;
      };
      invoices: {
        Row:    Invoice;
        Insert: Omit<Invoice, "id" | "created_at" | "updated_at" | "paid_at">;
        Update: Partial<Omit<Invoice, "id" | "profile_id" | "created_at" | "updated_at">>;
      };
      line_items: {
        Row:    LineItem;
...
export type InsertPricingPreset = Database["public"]["Tables"]["pricing_presets"]["Insert"];
...
export type InsertLineItem      = Database["public"]["Tables"]["line_items"]["Insert"];
