...
> = {
  ...
  cancelled: { label: "Cancelled", classes: "bg-slate-100 text-slate-400 ring-1 ring-slate-200"      },
};
...
// ── Quick actions ──────────────────────────────────────────────────────────
const quickActions = [
  { label: "New invoice", sub: "Bill a client",   icon: <IcFile size={15} />,  color: "bg-sky-50 text-sky-600 ring-1 ring-sky-200",         path: "/invoices/new" },
  { label: "New quote",   sub: "Send a proposal", icon: <IcQuote size={15} />, color: "bg-indigo-50 text-indigo-600 ring-1 ring-indigo-200", path: "/quotes/new"   },
  { label: "Add client",  sub: "Save contact",    icon: <IcUser size={15} />,  color: "bg-slate-100 text-slate-500 ring-1 ring-slate-200",   path: "/clients/new"  },
];
          ...
          <div className="bg-white rounded-2xl border border-slate-100 overflow-hidden">
            ...
            {!invoicesLoading && recentInvoices.length === 0 && (
              <div className="flex flex-col items-center justify-center py-16 text-center">
                ...
                <p className="text-slate-600 text-sm font-medium">No invoices yet</p>
                <p className="text-slate-400 text-xs mt-1">Create your first invoice to get started</p>
                <button
                  onClick={() => navigate("/invoices/new")}
